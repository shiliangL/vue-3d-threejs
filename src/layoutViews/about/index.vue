...
<template>
  <div class="about">
    <div class="ser-info-block">
      <img
        class="avatar"
        src="https://sf6-ttcdn-tos.pstatp.com/img/user-avatar/b5f32be5bcc2c15ff7145e5a6b8c13c4~300x300.image"
      >
      <div class="info-box">
        <div class="top">
          <h1 class="username">捏泥巴的小人
        ...
        <div class="intro flex-box-center">
          ...
          <span class="content"> 迷茫的时候就看书，焦虑的时候去学习 </span>
        </div>
        <!---->
      </div>
      ...
      <div class="action-box">
        <div class="link-box">
          <div class="weibo-link link inactive">
            <svg
              width="21"
              height="18"
              viewBox="0 0 21 18"
          ...
          <div class="github-link link inactive">
            <svg
              data-v-63b5b45a=""
              width="21"
              height="18"
        ...
        <div class="stat-action-block">
          <div class="item follow"><span class="count">12</span><span>关注</span></div>
          <div class="item follower"><span class="count">23</span><span>关注者</span></div>
          <div class="item follower"><span class="count">186</span><span>掘力值</span></div>
        </div>
      </div>
    </div>
  </div>
